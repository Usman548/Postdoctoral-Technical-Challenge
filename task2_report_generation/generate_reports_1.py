...
class MedicalReportGenerator:
    ...
    def __init__(self, 
        ...
        self.hf_token = hf_token or userdata.get('HF_TOKEN')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--token', type=str, default= userdata.get('HF_TOKEN'),
    ...
    # Check for token
    token = args.token or userdata.get('HF_TOKEN')
    if token is None:
        print("="*60)
